        ...
        <div class="container-fluid">
            ...
            <div class="col-md-3">
                ...
                <div class="card-body box-profile">
                    ...
                    <img class="profile-user-img img-fluid img-circle" v-bind:src="url(form.image)" v-bind:alt="username">
                    </div>

                    <h3 class="profile-username text-center">{{username}}</h3>

                    <p class="text-muted text-center">{{form.bio}}</p>
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">{{form.status}}</p>
                ...
                <div class="card-body">
                    ...
                    <div class="active tab-pane" id="activity">
                        ...
                        <div class="user-block">
                            <img class="img-circle img-bordered-sm" src="https://adminlte.io/themes/dev/AdminLTE/dist/img/user4-128x128.jpg" alt="user image">
                            <span class="username">
                    ...
                    <div class="tab-pane" id="settings">
                        ...
                        <div class="form-group row" v-if="form.role=='admin'">
                            <label for="inputSkills" class="col-sm-2 col-form-label">Role</label>
                            <div class="col-sm-10">
                                <select v-model="form.role" :class="{ 'is-invalid': form.errors.has('role') }">
                                    <option disabled>{{form.role}}</option>
                                    <option v-for="role in roles" :key="role.id" v-bind:value="role">{{role}}</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select v-model="form.status" :class="{ 'is-invalid': form.errors.has('status') }">
                                    <option disabled>{{form.status}}</option>
...
props: {
    ...
    mounted () {
        ...
        axios.get('/api/user/admin/'+this.userid).then( res => {
            console.log(res.data);
            this.username = res.data.user.username
            this.location = res.data.user.location
            this.roles = res.data.roles
            this.provider = res.data.user.provider
            //form data
            this.form.bio = res.data.user.bio
            this.form.first_name = res.data.user.first_name
            this.form.last_name = res.data.user.last_name
            this.form.status = res.data.user.status
            this.form.role = res.data.userRole[0]
            this.form.image = res.data.user.image
    ...
    methods: {
        updateUser() {
            ...
            this.form.post('/api/user/admin/'+this.userid)
